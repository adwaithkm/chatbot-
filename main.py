...
@app.post("/chatbot/")  # Make sure your frontend points to this endpoint
    ...
    try:
        ...
        chat_completion = client.chat.completions.create(
            messages=[
                {
                    "role": "user",
                    "content": f"Generate Output for: {user_input}",
                }
            ],
        ...
        return JSONResponse(content={"output": generated_code})  # Corrected variable name
